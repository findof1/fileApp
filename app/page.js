  ...
  return (
    <div className="flex flex-col">
      <div className="absolute left-[50%] w-[50%] h-[90%] top-[10%] bg-gray-400 z-10">
        <h1 className="absolute top-[20%] left-[21%] text-6xl text-center">{!userdata ? <p>Join our website <br></br> today</p> :<p>Search our library <br></br> of files today</p>}</h1>
        {userdata ? <Button route='/home' style="sm" extraStyles="absolute top-[45%] left-[40%] text-xl w-48">Start Searching</Button>: <></>}
      </div>
